...
tests/test_hf_dspark_cli: tests/test_hf_dspark_cli.o ds4_help.o $(HF_CLI_OBJS) linenoise.o ds4_gpu_args_cpu.o ds4_cpu_test_hooks.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_layer_pack.o
	$(CC) $(CFLAGS) -o $@ $^ $(LDLIBS)
